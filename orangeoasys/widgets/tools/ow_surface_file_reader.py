...
from orangeoasys.util.oasys_objects import OasysSurfaceData
...
class OWSurfaceFileReader(OWWidget):
    ...
    class Outputs:
        data = Output("Surface Data", OasysSurfaceData)
    ...
    def read_surface(self):
        try:
            ...
            self.Outputs.data.send(OasysSurfaceData(xx=self.xx, yy=self.yy, zz=self.zz, surface_data_file=self.surface_file_name))
...
if __name__ == "__main__":
    ...
    WidgetPreview(OWSurfaceFileReader).run()